...
{
    public class Lusilly3 : ModProjectile
    {
        //reblabla
        ...
        public override void AI()
        {
            ...
            if (mode == 1)//normal Att
            {
                ...
                float destinationRot = MathHelper.ToRadians(MathHelper.Lerp(160f, -160f, AsuUtils.ExpoInOut(easedTime)) * Projectile.direction * flipDir);
            ...
            else //idle
            {
                ...
                Vector2 pos = player.MountedCenter + Vector2.UnitX * player.direction * MathHelper.Lerp(-30f, -35f, easing) * 3.3f + Vector2.UnitY * MathHelper.Lerp(-80f, -90f, easing) * 0.2f;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = TextureAssets.Projectile[Type].Value;
            Texture2D textureShine = ModContent.Request<Texture2D>("asuw/Content/Projectiles/GBFstuff/Lusilly3Shined", AssetRequestMode.AsyncLoad).Value;
            Texture2D slashglow = ModContent.Request<Texture2D>("asuw/Content/Projectiles/GBFstuff/Lusilly3Glow", AssetRequestMode.AsyncLoad).Value;
            ...
            for (int i = 0; i < odr.Count; i++)
            {
                ...
                ve.Add(new ColoredVertex(odp[i] - Main.screenPosition + (odr[i].ToRotationVector2() * ((texture.Width / 3f) * ods[i]) * 1.5f),
                      ...
                      b));
                ve.Add(new ColoredVertex(odp[i] - Main.screenPosition + (odr[i].ToRotationVector2() * ((texture.Width / 6f) * ods[i] * -1)),
