...
{
    public class Mikafist2 : ModProjectile
    {
        ...
        {
            Lighting.AddLight(Projectile.Center, (0.568f / 2), (0.611f / 2), (0.85f / 2)); // R G B values from 0 to 1f. This is the red from the Crimson Heart pet
        ...
        int hmm = Main.rand.Next(18);
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {

            int width = Main.rand.Next(8);
            int height = Main.rand.Next(8);
            int dust3 = Dust.NewDust(Projectile.Center, width, height, 137);
