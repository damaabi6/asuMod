...
{
    public class BoundaryOfDeathUp: ModProjectile
    {

        Player player => Main.player[Projectile.owner];
        public override string Texture => "asuw/Content/Textures/ShiUltUphalf";
        SoundStyle yuzin = new("asuw/Content/Sounds/Yuzin_Special_Fin");
