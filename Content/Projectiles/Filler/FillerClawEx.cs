...
{
    public class FillerClawEx : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.timeLeft = 4; // The live time for the projectile (60 = 1 second, so 600 is 10 seconds)
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            SoundEngine.PlaySound(Claw_W.DrillHit, Projectile.Center); 
