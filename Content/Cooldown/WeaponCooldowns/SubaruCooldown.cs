...
{
    public class SubaruCooldown : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
                ...
                player.GetModPlayer<AsuPlayer>().CoolTick = 720 - player.GetModPlayer<AsuPlayer>().CoolTickDown;
                player.GetModPlayer<AsuPlayer>().CoolTickDown++;
                player.GetModPlayer<AsuPlayer>().WeaponCooldown = true;
                player.GetModPlayer<AsuPlayer>().SubaruFullAuto = true;
